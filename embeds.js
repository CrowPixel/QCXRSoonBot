...
const embeds = {
  ...
  location_resource_packs: new EmbedBuilder()
    ...
    .setDescription("You can find the Resource Pack folder in android/data/com.qcxr.qcxr/files/.minecraft/resourcepacks\nAny Resource Pack made for any version of Minecraft should work, but it is recommended you stick to ones made for either 1.18.2 or 1.19.3.\n\n Some packs may state they require certain optifine featutres to function\nIf that is the case, then there is some external mods you need to install for the packs to work properly\n These mods include:\n\n[CEM](https://github.com/YoungSoulluoS/Fresh-Animations-CEM-fork/releases)\n[CIT Resewn](https://www.curseforge.com/minecraft/mc-mods/cit-resewn)\n[Continuity](https://www.curseforge.com/minecraft/mc-mods/continuity)")
    .setColor("Greyple")
    .setFooter({ text: 'Written by TechyGiraffe999 & Pixel'}),
